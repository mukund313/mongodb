...
export const createUserRepo = async (uid: String, user: IUserInterface): Promise<boolean> => {
...
export const deleteUserWithTweetRepo = async ( userId: string, tweetId: string ): Promise<boolean> => {
